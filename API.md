...
* **props** (<code>[ImageProps](#cdk8s-image-imageprops)</code>)  *No description*
  ...
  * **name** (<code>string</code>) Tag for tagging the image. __*Optional*__
  * **tag**  (<code>string</code>) Path to Dockerfile. __*Optional*__
...
**file**? | <code>string</code> | Path to Dockerfile.<br/>__*Optional*__z
**name**? | <code>string</code> | Tag for tagging the image.<br/>__*Optional*__
**tag**? | <code>string</code> | Path to Dockerfile.<br/>__*Optional*__
